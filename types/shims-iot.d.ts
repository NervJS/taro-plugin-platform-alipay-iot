...
interface IxNativelist {
  items: string
  onItemClick: () => void
}

interface IxNativeGrid {
  items: string
  onItemClick: () => void
  onLoadmore: () => void
}
...
declare module '@tarojs/components' {
  ...
  export const IxGrid: ComponentType<IxGridProps>
  export const IxNativelist: ComponentType<IxNativelist>
  export const IxNativeGrid: ComponentType<IxNativeGrid>
}